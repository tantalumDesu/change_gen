...
def convert_gold_to_coins(gold):
    ...
    if gold >= 1000000:
        coin_weight = {'pp': 20*(randint(50, 120)/100), 'gp': 20*(randint(50, 120)/100), 'ep': 2*(randint(1, 120)/100), 'sp': 2*(randint(1, 120)/100), 'cp': 1*(randint(1, 120)/100)}
    elif gold >= 100000:
        ...
        coin_weight = {'pp': 5*(randint(10, 120)/100), 'gp': 5*(randint(10, 120)/100), 'ep': 1*(randint(1, 120)/100), 'sp': 2*(randint(1, 120)/100), 'cp': 2*(randint(1, 120)/100)}
    elif gold >= 1000:
    ...
    while total_copper > 0:
        ...
        ) if value <= total_copper and coin_counts[coin] < int(gold * 100) // value]
        if not options:
            break
    ...
    output = [f"{count:,}{coin}" for coin,
              count in coin_counts.items() if count > 0]
    return "\n".join(output)
